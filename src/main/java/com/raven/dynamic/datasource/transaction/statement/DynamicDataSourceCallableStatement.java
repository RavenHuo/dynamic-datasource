 ...
 */
public abstract class DynamicDataSourceCallableStatement extends DynamicDataSourcePreparedStatement implements CallableStatement {

    private CallableStatement stmt;
    DynamicDataSourceCallableStatement(DynamicDataSource dynamicDataSource, String sql) throws SQLException {
        super(dynamicDataSource, sql);
